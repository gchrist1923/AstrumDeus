...
export default function Home() {
  const rosterNyala = isMenuEnabled('roster', MENU_FLAGS)
  const pertandinganNyala = isMenuEnabled('matches', MENU_FLAGS)
  const partnerNyala = isMenuEnabled('partners', MENU_FLAGS)
  const beritaNyala = isMenuEnabled('news', MENU_FLAGS)
